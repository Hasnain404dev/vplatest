(function ($) {
    ...
    var crsBasic = function () {
        if ($('#map-panes').length) {
            ...
            // 🔽 Center map on Vision Plus
            map.setView({ lat: 31.523361246993158, lng: 74.34316767621588 }, 15);
    
            // 📍 Add Vision Plus marker
            var marker = L.marker([31.523361246993158, 74.34316767621588]).addTo(map);
            marker.bindPopup('<b>Vision Plus</b><br>Lahore, Pakistan').openPopup();
        }
    }
