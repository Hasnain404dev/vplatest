                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" 
                               value="{{ old('code', $coupon->code) }}" required readonly>
                        @error('code')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="discount_value" class="form-control" 
                               value="{{ old('discount_value', $coupon->discount_value) }}" step="0.01" min="0" required readonly>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="apply_on" class="form-select" required id="apply_on" disabled>
                            <option value="cart" {{ old('apply_on', $coupon->apply_on) == 'cart' ? 'selected' : '' }}>Entire Cart</option>
                            <option value="category" {{ old('apply_on', $coupon->apply_on) == 'category' ? 'selected' : '' }}>Category</option>
                            <option value="product" {{ old('apply_on', $coupon->apply_on) == 'product' ? 'selected' : '' }}>Product</option>
                            <option value="user" {{ old('apply_on', $coupon->apply_on) == 'user' ? 'selected' : '' }}>User Specific</option>
                        </select>
                        <input type="hidden" name="apply_on" value="{{ $coupon->apply_on }}">
                        ...
                        <div class="card border p-3 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="phone_email_assignments">
                                    ...
                                    @endphp
                                    @if($phoneEmailCustomers->count() > 0)
                                        @foreach($phoneEmailCustomers as $index => $customer)
                                            <div class="phone-email-row mb-2">
                                                <div class="row g-2">
                                                    <div class="col-md-5">
                                                        <input type="text" name="customer_phones[]" class="form-control" 
                                                               placeholder="Phone Number (e.g., 03001234567)" 
                                                               value="{{ old('customer_phones.' . $index, $customer->phone_number) }}">
                                                    </div>
                                                    <div class="col-md-5">
                                                        <input type="email" name="customer_emails[]" class="form-control" 
                                                               placeholder="Email Address" 
                                                               value="{{ old('customer_emails.' . $index, $customer->email) }}">
                                                    </div>
                                                    <div class="col-md-2">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" name="valid_until" class="form-control" 
                               value="{{ old('valid_until', $coupon->valid_until ? $coupon->valid_until->format('Y-m-d\TH:i') : '') }}" id="valid_until">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">OR Valid For (Days)</label>
                        <input type="number" name="valid_days" class="form-control" 
                               value="{{ old('valid_days', $validDays ? (int)$validDays : '') }}" min="1" step="1" id="valid_days">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="per_customer_limit" class="form-control" 
                               value="{{ old('per_customer_limit', $coupon->meta['per_customer_limit'] ?? '') }}" min="1">
                    </div>
                    <div class="col-md-6 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" name="show_sale_card" 
                                           id="show_sale_card" {{ old('show_sale_card', $coupon->show_sale_card) ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="color" name="card_color" class="form-control form-control-color" 
                                                   value="{{ old('card_color', $coupon->card_color ?? '#667eea') }}">
