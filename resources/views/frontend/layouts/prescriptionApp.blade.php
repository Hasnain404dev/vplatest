...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/prescription.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/lensesPrescription.css') }}" />
...
<body>
    ...
    <script src="{{ asset('frontend/assets/js/prescription.js') }}"></script>
    ...
    <script>
        const messages = [
            "👓 Abdullah from Lahore purchased Eyeglasses – 5 min ago",
            "🛍 Sara from Karachi just bought Screen Glasses  – few minutes ago!",
            "👓 Ali from Lahore purchased Eyeglasses  – few minutes ago!",
            "📦 Aysha from Islamabad ordered Contact Lenses 🔥 Just now!",
            "🛒 Hamza from Multan just placed an order 🔥 Just now!",
            "💼 Ahsan from Faisalabad bought Sunglasses ",
            "👓 Saqib Ali from Lahore purchased Club Master 🔥Stylish pick!",
        ];
        ...
        // Show popup every 15–25 seconds randomly
        setInterval(showSalePopup, Math.floor(Math.random() * 10000) + 5000);
    </script> --}}
    <!--Live sales notification  End-->
    @stack('scripts')
</body>
