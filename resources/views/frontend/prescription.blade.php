    ...
    <div class="container">
        <div class="eyeframe-section">
            <div class="eyeframe-details">
                <img id="eyeframeImage" class="eyeframe-image" src="{{ asset('uploads/products/' . $product->main_image) }}"
                    alt="Eyeframe" />
  ...
  ⚠ High Prescription Alert: Above ±4.00? Avoid basic lenses choose Super Thin 1.67 OR Ultra Thin 1.74 Index from below for thinner look.
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!urlParams.has('productId') && {{ $product->id }}) {
                urlParams.set('productId', '{{ $product->id }}');
