...
<html>
  <head>
    ...
    <!-- INCLUDE MAIN SCRIPT: -->
    <script src='{{ asset('threeDTryOn/dist/JeelizVTOWidget.js') }}'></script>
    ...
    <!-- main stylesheet: -->
    <link rel='stylesheet' href='{{ asset('threeDTryOn/css/JeelizVTOWidget.css') }}' />
    ...
    <script>
      ...
      function main() {
        JEELIZVTOWIDGET.start({
          ...
          sku: '{{ $product->threeD_try_on_name }}',
    ...
    <div class='content'>
      ...
      <div id='JeelizVTOWidget'>
        ...
        <div class='JeelizVTOWidgetControls' id='JeelizVTOWidgetChangeModelContainer'>
          <button onclick="JEELIZVTOWIDGET.load('{{ $product->threeD_try_on_name }}')">Try On {{ $product->name }}</button>
        </div>
