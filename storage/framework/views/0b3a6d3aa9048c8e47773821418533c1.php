...
<html>
  <head>
    <title>Glasses Virtual Try-On</title>
    <meta charset='utf-8' />
    ...
    <!-- INCLUDE MAIN SCRIPT: -->
    <script src='<?php echo e(asset('threeDTryOn/dist/JeelizVTOWidget.js')); ?>'></script>
    ...
    <!-- main stylesheet: -->
    <link rel='stylesheet' href='<?php echo e(asset('threeDTryOn/css/JeelizVTOWidget.css')); ?>' />
    ...
    <script>
      ...
      function main() {
        JEELIZVTOWIDGET.start({
          ...
          sku: '<?php echo e($product->threeD_try_on_name); ?>',
    ...
    <div class='content'>
      ...
      <div class='header'>
        <div class="headerTitle">
          <?php echo e($product->name); ?> Virtual Try-On
        </div>
      </div>
      ...
      <div id='JeelizVTOWidget'>
        ...
        <div class='JeelizVTOWidgetControls' id='JeelizVTOWidgetChangeModelContainer'>
          <button onclick="JEELIZVTOWIDGET.load('<?php echo e($product->threeD_try_on_name); ?>')">Try On <?php echo e($product->name); ?></button>
        </div>
...
<?php /**PATH D:\visionPlus\visionPlus-new\vplatest\resources\views\virtual-try-on\treeDTryOn.blade.php ENDPATH**/ ?>