        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Blog
                    <span></span> <?php echo e($blog->title); ?>
                    ...
                    <div class="col-lg-10 m-auto">
                        <div class="single-page pl-30">
                            <div class="single-header style-2">
                                ...
                                <div class="single-header-meta">
                                    <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                        <span class="post-on has-dot"><?php echo e($blog->created_at->format('d M Y')); ?></span>
                                    </div>
                            ...
                            <figure class="single-thumbnail">
                                <img src="<?php echo e(asset('uploads/blogs/' . $blog->image)); ?>" alt="blog thumnail "  loading="lazy" decoding="async">
                            </figure>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\visionPlus\visionPlus-new\vplatest\resources\views\frontend\blogDetail.blade.php ENDPATH**/ ?>