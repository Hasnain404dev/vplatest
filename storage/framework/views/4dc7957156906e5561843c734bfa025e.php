                    ...
                    <div class="text-center">
                        ...
                        <p class="wow fadeIn animated">
                            <a class="btn btn-brand btn-lg font-weight-bold text-white border-radius-5 btn-shadow-brand hover-up"
                                href="<?php echo e(route('frontend.aboutUs')); ?>">About Us</a>
                    ...
                    <div class="col-xl-8 col-lg-10 m-auto">
                        <div class="contact-from-area padding-20-row-col wow FadeInUp">
                            ...
                            <form class="contact-form-style text-center" id="contact-form"
                                action="<?php echo e(route('frontend.contactUs.store')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\visionPlus\visionPlus-new\vplatest\resources\views\frontend\contactUs.blade.php ENDPATH**/ ?>