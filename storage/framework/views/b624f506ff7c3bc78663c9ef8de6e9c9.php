                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?php echo e(asset($slider->image_desktop ?? $slider->image)); ?>" alt="Desktop Banner" class="img-thumbnail" style="max-height: 150px;">
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="mb-2">
                                        <?php if($slider->image_mobile): ?>
                                            <img src="<?php echo e(asset($slider->image_mobile)); ?>" alt="Mobile Banner" class="img-thumbnail" style="max-height: 150px;">
                                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <?php $headingColor = $slider->heading_color ?? ($slider->text_color ?? '#ffffff'); ?>
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="color" class="form-control form-control-color" id="heading_color_picker" value="<?php echo e($headingColor); ?>" style="width:3rem;height:2.25rem;">
                                        <input type="text" class="form-control" id="heading_color" name="heading_color" value="<?php echo e(old('heading_color', $headingColor)); ?>" placeholder="#ffffff">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <?php $subHeadingColor = $slider->sub_heading_color ?? ($slider->text_color ?? '#ffffff'); ?>
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="color" class="form-control form-control-color" id="sub_heading_color_picker" value="<?php echo e($subHeadingColor); ?>" style="width:3rem;height:2.25rem;">
                                        <input type="text" class="form-control" id="sub_heading_color" name="sub_heading_color" value="<?php echo e(old('sub_heading_color', $subHeadingColor)); ?>" placeholder="#ffffff">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <?php $paragraphColor = $slider->paragraph_color ?? ($slider->text_color ?? '#ffffff'); ?>
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="color" class="form-control form-control-color" id="paragraph_color_picker" value="<?php echo e($paragraphColor); ?>" style="width:3rem;height:2.25rem;">
                                        <input type="text" class="form-control" id="paragraph_color" name="paragraph_color" value="<?php echo e(old('paragraph_color', $paragraphColor)); ?>" placeholder="#ffffff">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="range" class="form-range" id="background_opacity" name="background_opacity" min="0" max="100" value="<?php echo e(old('background_opacity', $opacityPct)); ?>">
                                    <small class="text-muted"><span id="background_opacity_val"><?php echo e(old('background_opacity', $opacityPct)); ?></span>% (darker = more readable text)</small>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="color" class="form-control form-control-color" id="text_color_picker" value="<?php echo e($textColor); ?>" style="width:3rem;height:2.25rem;">
                                        <input type="text" class="form-control" id="text_color" name="text_color" value="<?php echo e(old('text_color', $textColor)); ?>" placeholder="#ffffff">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="color" class="form-control form-control-color" id="button_bg_color_picker" value="<?php echo e($btnBgColor); ?>" style="width:3rem;height:2.25rem;">
                                        <input type="text" class="form-control" id="button_bg_color" name="button_bg_color" value="<?php echo e(old('button_bg_color', $btnBgColor)); ?>" placeholder="#0d6efd">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex align-items-center gap-2 mt-1">
                                        <input type="color" class="form-control form-control-color" id="button_color_picker" value="<?php echo e($slider->button_color ?? $btnBgColor); ?>" style="width:3rem;height:2.25rem;">
                                        <input type="text" class="form-control" id="button_color" name="button_color" value="<?php echo e(old('button_color', $slider->button_color)); ?>" placeholder="#0d6efd">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="color" class="form-control form-control-color" id="button_text_color_picker" value="<?php echo e($btnTextColor); ?>" style="width:3rem;height:2.25rem;">
                                        <input type="text" class="form-control" id="button_text_color" name="button_text_color" value="<?php echo e(old('button_text_color', $btnTextColor)); ?>" placeholder="#ffffff">
                                    </div>
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\world\Desktop\vppp\vplatest\resources\views/backend/sliders/edit.blade.php ENDPATH**/ ?>