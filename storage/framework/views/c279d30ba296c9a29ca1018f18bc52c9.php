...
<meta property="og:title" content="VisionPlus Opticians Pakistan | Stylish Eyewear & Expert Eye Care" />
<meta property="og:description" content="Pakistan’s #1 online optical store for premium glasses, lenses, and sunglasses." />
<meta property="og:type" content="website" />
<meta property="og:url" content="https://visionplus.pk/" />
<meta property="og:image" content="https://visionplus.pk/frontend/assets/imgs/theme/logowhatsapp.png" />
<meta property="og:site_name" content="VisionPlus Opticians" />

<meta name="description" content="Pakistan’s #1 online optical store for premium glasses, lenses, and sunglasses." />
...
<noscript>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,400;0,700;1,400&family=Spartan:wght@400;600&display=swap">
    ...
    <!-- Favicon -->
  <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('frontend/assets/imgs/theme/faviconvp.ico')); ?>" />
    <link rel="icon" type="image/png" sizes="512x512" href="<?php echo e(asset('frontend/assets/imgs/theme/favicon-512x512.png')); ?>" />
    <!-- Template CSS -->
...
<!--</script>-->
        <!-- Google tag (Google Ads as primary) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-17826290518"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  ...
  // Google Ads (MAIN)
  gtag('config', 'AW-17826290518');

  // GA4 (Secondary but active)
  gtag('config', 'G-03LLVGZMRD');
</script>
    <!-- Custom CSS -->
...
<?php /**PATH C:\Users\world\Desktop\vppp\vplatest\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>