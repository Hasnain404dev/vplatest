...
unset($__errorArgs, $__bag); ?>
                                    <small class="text-muted">Leave blank to keep current desktop banner</small>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    <small class="text-muted">Leave blank to keep current (or continue using desktop)</small>
                                </div>
